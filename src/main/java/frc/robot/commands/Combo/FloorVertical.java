...
public class FloorVertical extends ParallelCommandGroup {
   ...
   */
  public FloorVertical(ArmProfiled arm, ElevatorProfiled lift, Pneumatics air, Swerve drive) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new SetHeight(ElevatorConstants.kTippedConeHeight, lift), // Sets the Elevator to the right height.
      new SetAngle(ArmConstants.kTippedConeAngle, arm), // Sets the arm to the right angle.
