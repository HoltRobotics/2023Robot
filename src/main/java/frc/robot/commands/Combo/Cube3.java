...
public class Cube3 extends ParallelCommandGroup {
  /**
   ...
   */
  public Cube3(ArmProfiled arm, ElevatorProfiled lift, Pneumatics air, Swerve drive) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new SetHeight(ElevatorConstants.kCube3Height, lift), // Sets the Elevator to the right height.
